    ...
    return (
      <div class="ps-ec-container">
        ...
        <div class="ps-ec-input-group">
          <input class="ps-ec-inputbox" placeholder={this.placeholder}></input>
          <button class="ps-ec-button">{this.btnText}</button>
        </div>
        ...
        <p class="ps-ec-success-msg">Success message</p>
        <p class="ps-ec-failed-msg">Error message</p>
      </div>
    );
  }
}
